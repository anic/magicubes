...
public class ReaderLayer extends GLayer {
    ...
    private void drawShortMenu(Graphics g, int x, int y, int width, int height) {
        if (this.status == STATUS_VIEW) {
            ...
            DrawingUtil.drawMenuIcon(g, x + width - 2 * menu_icon_width - space, y, menu_icon_width, menu_icon_height, Common.COLOR_BAR, Common.COLOR_SELECTED, "右", Common.FONT_DEFAULT);
